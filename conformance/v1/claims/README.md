...
Each implementation claim should declare:
...
- optional surfaces not implemented

Claims should be narrower than or equal to the verified result.

Seed artifact:

- `claim-template.md`
- `core-http-claim-seed.md`
- `core-approvals-http-claim-seed.md`
